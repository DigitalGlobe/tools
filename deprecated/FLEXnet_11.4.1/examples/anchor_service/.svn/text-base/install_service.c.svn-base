...
sUsage()
{
	printf("Usage: installanchorservice publisher_name product_name\n");
}
...
main(int argc, char * argv[])
{
	...
	if(!fnpActSvcInstallWin(pszPublisherName, pszProductName))
	{
		printf("Error %d attempting to install service\n", fnpActSvcGetLastErrorWin());
	}
	else
	{
		printf("Successfully installed anchor service for publisher %s, product %s\n", pszPublisherName, pszProductName);
	}
