...
struct CStreamKey
{
    ...
    {
        static const CoreType  PlainKeys[4] = { PLAIN_KEY_0, PLAIN_KEY_1, PLAIN_KEY_2, PLAIN_KEY_3 };
        static const CoreType  EncodedKeys[4] = { ENCODED_KEY_0, ENCODED_KEY_1, ENCODED_KEY_2, ENCODED_KEY_3 };
