...
#define FLEXLM_SUB_MINOR_REVISION 100
#define FLEXLM_PATCH_NUMBER       0 

#define FLEXLM_PATCH ""	/* no longer used */
#define MAX_PATCH_SIZE 1	/* Max length of a patch letter */
#define FLEXLM_VERSION_REVISION_STRING "11.4.100.0"
#define FLEXLM_COPYRIGHT_YEAR "2007"
...
#define LM_ONE_TSOK_ERR			-174 /** Not more than one Remote Session per Feature is allowed */ 
#define LM_LAST_ERRNO			-174  /** The last valid error number */
/*  WARNING
