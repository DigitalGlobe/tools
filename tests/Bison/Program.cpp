...
// global variables
    ...
    string g_sBisonExecutableFileName;
    //-------------------------------------------------------------------------
...
static void DisplayUsage()
{
    ::printf("Usage: Bison.exe <bison_executable_file_name> <input_file_name> output_file_name>");
    ::printf("\n");
}
//-----------------------------------------------------------------------------
/**
                                        ...
                                        char* argv[] )
{
    ...
    if (argc == 4)
    {
        ::g_sBisonExecutableFileName = argv[1];
        ::g_sInputFileName           = argv[2];
        ::g_sOutputFileName          = argv[3];
        iResult                      = 0;
    }
    else
    {
