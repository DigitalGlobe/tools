...
class Program :
    ...
    # constants
        ...
        _DESCRIPTION = "Tests the LibICONV library."
        #----------------------------------------------------------------------
        ...
        _FILE_NAME_SOLUTION = "LibICONVTest.sln"
        #----------------------------------------------------------------------
        # the name of the 32-bit debug test file
        _FILE_NAME_TEST_DEBUG_X86 = "LibICONVTest.exe"
        #----------------------------------------------------------------------
        # the name of the 32-bit release test file
        _FILE_NAME_TEST_RELEASE_X86 = "LibICONVTest.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit debug test file
        _FILE_NAME_TEST_DEBUG_X64 = "LibICONVTest.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit release test file
        _FILE_NAME_TEST_RELEASE_X64 = "LibICONVTest.exe"
        #----------------------------------------------------------------------
            ...
            if ( buildSettings.ReleaseSpecified() ) :
                ...
                if ( buildSettings.X64Specified() ) :
                    ...
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\libiconv.dll"      ,
                                            "LibICONV\\x64\\Release\\libiconv.dll" )
                                            
                else :
                
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\libiconv.dll"      ,
                                            "LibICONV\\Release\\libiconv.dll"      )
                ...
                if ( buildSettings.X64Specified() ) :
                    ...
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\libiconv_d.dll"    ,
                                            "LibICONV\\x64\\Debug\\libiconvd.dll"  )
                                            
                else :
                
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\libiconv_d.dll"    ,
                                            "LibICONV\\Debug\\libiconvd.dll"       )
