...
class Program :
    ...
    # constants
        ...
        _DESCRIPTION = "Tests the QuaZIP library."
        #----------------------------------------------------------------------
        ...
        _FILE_NAME_SOLUTION = "QuaZIPTest.sln"
        #----------------------------------------------------------------------
        # the name of the 32-bit debug test file
        _FILE_NAME_TEST_DEBUG_X86 = "QuaZIPTest.exe"
        #----------------------------------------------------------------------
        # the name of the 32-bit release test file
        _FILE_NAME_TEST_RELEASE_X86 = "QuaZIPTest.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit debug test file
        _FILE_NAME_TEST_DEBUG_X64 = "QuaZIPTest.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit release test file
        _FILE_NAME_TEST_RELEASE_X64 = "QuaZIPTest.exe"
        #----------------------------------------------------------------------
        ...
        def main(self) :
            ...
            if ( buildSettings.ReleaseSpecified() ) :
                ...
                if ( buildSettings.X64Specified() ) :
                    ...
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\quazip.dll"     ,
                                            "QuaZIP\\x64\\Release\\quazip.dll"  )
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\Qt5Core.dll"    ,
                                            "QuaZIP\\x64\\Release\\Qt5Core.dll" )
                                            
                else :
                
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\quazip.dll"     ,
                                            "QuaZIP\\Release\\quazip.dll"       )
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\Qt5Core.dll"    ,
                                            "QuaZIP\\Release\\Qt5Core.dll"      )
                                            
            else :
            
                if ( buildSettings.X64Specified() ) :
                
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\quazip_d.dll"   ,
                                            "QuaZIP\\x64\\Debug\\quazip.dll"    )
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\Qt5Core.dll"    ,
                                            "QuaZIP\\x64\\Debug\\Qt5Cored.dll"  )
                                            
                else :
                
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\quazip_d.dll"   ,
                                            "QuaZIP\\Debug\\quazip.dll"         )
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\Qt5Core_d.dll"  ,
                                            "QuaZIP\\Debug\\Qt5Cored.dll"       )
