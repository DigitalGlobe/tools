...
class Program :
    ...
    # constants
        ...
        _DESCRIPTION = "Tests the Bison library."
        #----------------------------------------------------------------------
        ...
        _FILE_NAME_SOLUTION = "Bison.sln"
        #----------------------------------------------------------------------
        # the name of the 32-bit debug executable file
        _FILE_NAME_EXECUTABLE_DEBUG_X86 = "bison_d.exe"
        #----------------------------------------------------------------------
        # the name of the 32-bit release executable file
        _FILE_NAME_EXECUTABLE_RELEASE_X86 = "bison.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit debug executable file
        _FILE_NAME_EXECUTABLE_DEBUG_X64 = "bison_d.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit release executable file
        _FILE_NAME_EXECUTABLE_RELEASE_X64 = "bison.exe"
        #----------------------------------------------------------------------
        # the name of the input file
        _FILE_NAME_INPUT = "data\\ex1.ypp"
        #----------------------------------------------------------------------
        # the name of the output file
        _FILE_NAME_OUTPUT = "ex1.tab.cpp"
        #----------------------------------------------------------------------
        # the name of the 32-bit debug test file
        _FILE_NAME_TEST_DEBUG_X86 = "Bison.exe"
        #----------------------------------------------------------------------
        # the name of the 32-bit release test file
        _FILE_NAME_TEST_RELEASE_X86 = "Bison.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit debug test file
        _FILE_NAME_TEST_DEBUG_X64 = "Bison.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit release test file
        _FILE_NAME_TEST_RELEASE_X64 = "Bison.exe"
        #----------------------------------------------------------------------
