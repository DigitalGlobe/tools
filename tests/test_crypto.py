...
# test_crypto.py
#
# Summary : Tests the Crypto++ library.
#
#------------------------------------------------------------------------------
...
class Program :
    ...
    # constants
        ...
        _DESCRIPTION = "Tests the Crypto++ library."
        #----------------------------------------------------------------------
        ...
        _FILE_NAME_SOLUTION = "Crypto.sln"
        #----------------------------------------------------------------------
        # the name of the 32-bit debug dynamic file
        _FILE_NAME_DYNAMIC_DEBUG_X86 = "cryptopp_d.dll"
        #----------------------------------------------------------------------
        # the name of the 32-bit release dynamic file
        _FILE_NAME_DYNAMIC_RELEASE_X86 = "cryptopp.dll"
        #----------------------------------------------------------------------
        # the name of the 64-bit debug dynamic file
        _FILE_NAME_DYNAMIC_DEBUG_X64 = "cryptopp_d.dll"
        #----------------------------------------------------------------------
        # the name of the 64-bit release dynamic file
        _FILE_NAME_DYNAMIC_RELEASE_X64 = "cryptopp.dll"
        #----------------------------------------------------------------------
        # the name of the 32-bit debug test file
        _FILE_NAME_TEST_DEBUG_X86 = "Crypto.exe"
        #----------------------------------------------------------------------
        # the name of the 32-bit release test file
        _FILE_NAME_TEST_RELEASE_X86 = "Crypto.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit debug test file
        _FILE_NAME_TEST_DEBUG_X64 = "Crypto.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit release test file
        _FILE_NAME_TEST_RELEASE_X64 = "Crypto.exe"
        #----------------------------------------------------------------------
    ...
    # public methods
        ...
        def main(self) :
            ...
            # get the path names
            libraryPathName = ( Program._PATH_NAME_LIBRARY_X64      \
            ...
            systemManager.copyFile( os.path.join( libraryPathName , \
                                                  fileDistributor.determinePathName( buildSettings.X64Specified()           , \
                                                                                     buildSettings.ReleaseSpecified()       , \
                                                                                     Program._FILE_NAME_DYNAMIC_DEBUG_X86   , \
                                                                                     Program._FILE_NAME_DYNAMIC_RELEASE_X86 , \
                                                                                     Program._FILE_NAME_DYNAMIC_DEBUG_X64   , \
                                                                                     Program._FILE_NAME_DYNAMIC_RELEASE_X64 ) ) ,
                                    os.path.join( compilePathName , \
                                                  "cryptopp.dll"  )                                                             )
