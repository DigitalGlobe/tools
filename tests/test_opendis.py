...
class Program :
    ...
    # constants
        ...
        _DESCRIPTION = "Tests the OpenDIS library."
        #----------------------------------------------------------------------
        ...
        _FILE_NAME_SOLUTION = "OpenDISTest.sln"
        #----------------------------------------------------------------------
        # the name of the 32-bit debug test file
        _FILE_NAME_TEST_DEBUG_X86 = "OpenDISTest.exe"
        #----------------------------------------------------------------------
        # the name of the 32-bit release test file
        _FILE_NAME_TEST_RELEASE_X86 = "OpenDISTest.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit debug test file
        _FILE_NAME_TEST_DEBUG_X64 = "OpenDISTest.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit release test file
        _FILE_NAME_TEST_RELEASE_X64 = "OpenDISTest.exe"
        #----------------------------------------------------------------------
        ...
        def main(self) :
            ...
            if ( buildSettings.ReleaseSpecified() ) :
                ...
                if ( buildSettings.X64Specified() ) :
                    ...
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\DIS.dll"     ,
                                            "OpenDIS\\x64\\Release\\DIS.dll" )
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\DIS.dll"     ,
                                            "OpenDIS\\x64\\Release\\DIS.dll" )
                                            
                else :
                
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\DIS.dll" ,
                                            "OpenDIS\\Release\\DIS.dll"  )
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\DIS.dll" ,
                                            "OpenDIS\\Release\\DIS.dll"  )
                ...
                if ( buildSettings.X64Specified() ) :
                    ...
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\DIS_d.dll"       ,
                                            "OpenDIS\\x64\\Debug\\DIS_debug.dll" )
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\DIS_d.dll"       ,
                                            "OpenDIS\\x64\\Debug\\DIS_debug.dll" )
                                            
                else :
                
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\DIS_d.dll"  ,
                                            "OpenDIS\\Debug\\DIS_debug.dll" )
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\DIS_d.dll"  ,
                                            "OpenDIS\\Debug\\DIS_debug.dll" )
