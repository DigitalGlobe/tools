...
class Program :
    ...
    # constants
        ...
        _DESCRIPTION = "Tests the APR Util library."
        #----------------------------------------------------------------------
        ...
        _FILE_NAME_TEST_DEBUG_X86 = "AprUtil.exe"
        #----------------------------------------------------------------------
        # the name of the 32-bit release test file
        _FILE_NAME_TEST_RELEASE_X86 = "AprUtil.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit debug test file
        _FILE_NAME_TEST_DEBUG_X64 = "AprUtil.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit release test file
        _FILE_NAME_TEST_RELEASE_X64 = "AprUtil.exe"
        #----------------------------------------------------------------------
            ...
            if ( buildSettings.ReleaseSpecified() ) :
                ...
                if ( buildSettings.X64Specified() ) :
                    ...
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\apr.dll"                ,
                                            "AprUtil\\x64\\Release\\libapr-1.dll"       )
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\aprutil.dll"            ,
                                            "AprUtil\\x64\\Release\\libaprutil-1.dll"   )
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\apriconv.dll"           ,
                                            "AprUtil\\x64\\Release\\libapriconv-1.dll"  )
                                            
                else :
                
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\apr.dll"                ,
                                            "AprUtil\\Release\\libapr-1.dll"            )
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\aprutil.dll"            ,
                                            "AprUtil\\Release\\libaprutil-1.dll"        )
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\apriconv.dll"           ,
                                            "AprUtil\\Release\\libapriconv-1.dll"       )
                ...
                if ( buildSettings.X64Specified() ) :
                    ...
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\apr_d.dll"              ,
                                            "AprUtil\\x64\\Debug\\libapr-1.dll"         )
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\aprutil_d.dll"          ,
                                            "AprUtil\\x64\\Debug\\libaprutil-1.dll"     )
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\apriconv_d.dll"         ,
                                            "AprUtil\\x64\\Debug\\libapriconv-1.dll"    )
                                            
                else :
                
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\apr_d.dll"              ,
                                            "AprUtil\\Debug\\libapr-1.dll"              )
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\aprutil_d.dll"          ,
                                            "AprUtil\\Debug\\libaprutil-1.dll"          )
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\apriconv_d.dll"         ,
                                            "AprUtil\\Debug\\libapriconv-1.dll"         )
