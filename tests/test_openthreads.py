...
class Program :
    ...
    # constants
        ...
        _DESCRIPTION = "Tests the OpenThreads library."
        #----------------------------------------------------------------------
        ...
        _FILE_NAME_SOLUTION = "OpenThreads.sln"
        #----------------------------------------------------------------------
        # the name of the 32-bit debug test file
        _FILE_NAME_TEST_DEBUG_X86 = "OpenThreads.exe"
        #----------------------------------------------------------------------
        # the name of the 32-bit release test file
        _FILE_NAME_TEST_RELEASE_X86 = "OpenThreads.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit debug test file
        _FILE_NAME_TEST_DEBUG_X64 = "OpenThreads.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit release test file
        _FILE_NAME_TEST_RELEASE_X64 = "OpenThreads.exe"
        #----------------------------------------------------------------------
        ...
        def main(self) :
            ...
            if ( buildSettings.ReleaseSpecified() ) :
                ...
                if ( buildSettings.X64Specified() ) :
                    ...
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\openthreads.lib"          ,
                                            "..\\sdk\\x64\\lib\\OpenThreadsWin32.lib"     )
                                            
                else :
                
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\openthreads.lib"          ,
                                            "..\\sdk\\x86\\lib\\OpenThreadsWin32.lib"     )
                                            
            else :
            
                if ( buildSettings.X64Specified() ) :
                
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\openthreads_d.lib"        ,
                                            "..\\sdk\\x64\\lib\\OpenThreadsWin32d.lib"    )
                                            
                else :
                
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\openthreads_d.lib"        ,
                                            "..\\sdk\\x86\\lib\\OpenThreadsWin32d.lib"    )
            ...
            if ( buildSettings.ReleaseSpecified() ) :
                ...
                if ( buildSettings.X64Specified() ) :
                    ...
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\openthreads.dll"              ,
                                            "OpenThreads\\x64\\Release\\OpenThreadsWin32.dll" )
                                            
                else :
                
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\openthreads.dll"              ,
                                            "OpenThreads\\Release\\OpenThreadsWin32.dll"      )
                                            
            else :
            
                if ( buildSettings.X64Specified() ) :
                
                    systemManager.copyFile( "..\\sdk\\x64\\lib\\openthreads_d.dll"            ,
                                            "OpenThreads\\x64\\Debug\\OpenThreadsWin32d.dll"  )
                                            
                else :
                
                    systemManager.copyFile( "..\\sdk\\x86\\lib\\openthreads_d.dll"            ,
                                            "OpenThreads\\Debug\\OpenThreadsWin32d.dll"       )
