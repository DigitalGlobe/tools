...
class Program :
    ...
    # constants
        ...
        _DESCRIPTION = "Tests the GSoap library."
        #----------------------------------------------------------------------
        ...
        _FILE_NAME_SOLUTION = "GSoap.sln"
        #----------------------------------------------------------------------
        # the name of the 32-bit debug executable file
        _FILE_NAME_EXECUTABLE_DEBUG_X86 = "soapcpp2_d.exe"
        #----------------------------------------------------------------------
        # the name of the 32-bit release executable file
        _FILE_NAME_EXECUTABLE_RELEASE_X86 = "soapcpp2.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit debug executable file
        _FILE_NAME_EXECUTABLE_DEBUG_X64 = "soapcpp2_d.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit release executable file
        _FILE_NAME_EXECUTABLE_RELEASE_X64 = "soapcpp2.exe"
        #----------------------------------------------------------------------
        # the name of the expected file
        _FILE_NAME_EXPECTED = "data\\soapH.h"
        #----------------------------------------------------------------------
        # the name of the input file
        _FILE_NAME_INPUT = "data\\calc.h"
        #----------------------------------------------------------------------
        # the name of the output file
        _FILE_NAME_OUTPUT = "soapH.h"
        #----------------------------------------------------------------------
        # the name of the 32-bit debug test file
        _FILE_NAME_TEST_DEBUG_X86 = "GSoap.exe"
        #----------------------------------------------------------------------
        # the name of the 32-bit release test file
        _FILE_NAME_TEST_RELEASE_X86 = "GSoap.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit debug test file
        _FILE_NAME_TEST_DEBUG_X64 = "GSoap.exe"
        #----------------------------------------------------------------------
        # the name of the 64-bit release test file
        _FILE_NAME_TEST_RELEASE_X64 = "GSoap.exe"
        #----------------------------------------------------------------------
    ...
    # public methods
        ...
        def main(self) :
            ...
            outputPathName  = os.path.join( testPathName              ,
                                            Program._PATH_NAME_OUTPUT );
            systemManager.removeDirectory(outputPathName)
            systemManager.makeDirectory(outputPathName)
            ...
            outputFileName     = os.path.join( outputPathName              ,
                                               Program._FILE_NAME_OUTPUT   );
            expectedFileName   = os.path.join( testPathName                ,
                                               Program._FILE_NAME_EXPECTED );
