...
CFLAGS	=	/nologo -c -W3 -Ox  -EHsc -I. $(OPTFLAGS)
...
tmt.exe:       	$(tmt_obj) $(LIB_NAME)
		link -Out:$@ $(conlibs) $(tmt_obj) $(LIB_NAME)

example_obj = example.obj

example.exe:   	$(example_obj) $(LIB_NAME)
		link -Out:$@ $(conlibs) $(example_obj) $(LIB_NAME)

nm_ex1_obj = nm_ex1.obj

nm_ex1.exe:    	$(nm_ex1_obj) $(LIB_NAME)
		link -Out:$@ $(conlibs) $(nm_ex1_obj) $(LIB_NAME)

nm_ex2_obj = nm_ex2.obj

nm_ex2.exe:    	$(nm_ex2_obj) $(LIB_NAME)
		link -Out:$@ $(conlibs) $(nm_ex2_obj) $(LIB_NAME)

nm_ex3_obj = nm_ex3.obj

nm_ex3.exe:    	$(nm_ex3_obj) $(LIB_NAME)
		link -Out:$@ $(conlibs) $(nm_ex3_obj) $(LIB_NAME)

test_exc_obj = test_exc.obj

test_exc.exe:  	$(test_exc_obj) $(LIB_NAME)
		link -Out:$@ $(conlibs) $(test_exc_obj) $(LIB_NAME)

nl_ex_obj = nl_ex.obj newmatnl.obj

nl_ex.exe:     	$(nl_ex_obj) $(LIB_NAME)
		link -Out:$@ $(conlibs) $(nl_ex_obj) $(LIB_NAME)
...
garch.exe:     	$(garch_obj) $(LIB_NAME)
		link -Out:$@ $(conlibs) $(garch_obj) $(LIB_NAME)
