...
Build Date:  April 06, 2025
Build Version:  1.5.4.326
Version:  v 1.5.4


          Esri File Geodatabase API for Windows Windows 64-bit README
          ----------------------------------------------------------------------
...
TO BUILD THE SAMPLES ON WINDOWS 64-bit:
    C++
        ...
        2) Open the samples project (FileGDB_API\samples\samples_VS2022.sln).
    ...
    C#
        1) Open Visual Studio.
        2) Open the samples project (FileGDB_API\samplesC#\samplesCsharp_VS2022.sln).
        3) Change the Solution Platform to x64.
        4) In the solution explorer, right click on the solution (the top of the tree) and 
        select "Rebuild Solution". The samples will begin to build. Ignore all warnings. You will
...
of the API. A MS Visual Studio 2022 Solution and Projects are included for 
