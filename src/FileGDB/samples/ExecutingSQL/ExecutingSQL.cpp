...
int main()
{
  ...
  wcout << "\nSELECT CITY_NAME, POP1990 FROM Cities WHERE TYPE = 'city' AND OBJECTID < 10\n" << endl;
  ...
  // SELECT using a SIMILAR TO (regex) clause
  sqlStatement.assign (L"SELECT CITY_NAME, POP1990 FROM Cities WHERE CITY_NAME SIMILAR TO 'Redmond|Burien'");
