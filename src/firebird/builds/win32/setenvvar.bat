...
echo "%FB_PROCESSOR_ARCHITECTURE%"
...
@"%VS140COMNTOOLS%\..\IDE\devenv" /? >nul 2>nul
...
@"%VS120COMNTOOLS%\..\IDE\devenv" /? >nul 2>nul
...
@"%VS100COMNTOOLS%\..\IDE\devenv" /? >nul 2>nul
...
@"%VS71COMNTOOLS%\..\IDE\devenv" /? >nul 2>nul
