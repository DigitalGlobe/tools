...
-DKAKADU_ROOT_SRC=$OSSIM_DEV_HOME/kakadu/latest \
-DKAKADU_AUX_LIBRARY=$OSSIM_DEV_HOME/kakadu/latest/lib/Linux-x86-64-gcc/libkdu_aux.a \
-DKAKADU_LIBRARY=$OSSIM_DEV_HOME/kakadu/latest/lib/Linux-x86-64-gcc/libkdu.a  \
../ossim-kakadu-plugin
...
%changelog
* Mon Jan 6 2013 David Burken <dburken@- 1.8.18-1
- Initial package
