...
const QMetaObject TestQuaZipDir::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestQuaZipDir.data,
      qt_meta_data_TestQuaZipDir,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TestQuaZipDir::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TestQuaZipDir.stringdata0))
        return static_cast<void*>(const_cast< TestQuaZipDir*>(this));
