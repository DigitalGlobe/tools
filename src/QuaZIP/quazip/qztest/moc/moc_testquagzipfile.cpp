...
const QMetaObject TestQuaGzipFile::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestQuaGzipFile.data,
      qt_meta_data_TestQuaGzipFile,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TestQuaGzipFile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TestQuaGzipFile.stringdata0))
        return static_cast<void*>(const_cast< TestQuaGzipFile*>(this));
