...
const QMetaObject TestQuaZipNewInfo::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestQuaZipNewInfo.data,
      qt_meta_data_TestQuaZipNewInfo,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TestQuaZipNewInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TestQuaZipNewInfo.stringdata0))
        return static_cast<void*>(const_cast< TestQuaZipNewInfo*>(this));
