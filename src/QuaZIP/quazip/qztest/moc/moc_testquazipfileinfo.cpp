...
const QMetaObject TestQuaZipFileInfo::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestQuaZipFileInfo.data,
      qt_meta_data_TestQuaZipFileInfo,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TestQuaZipFileInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TestQuaZipFileInfo.stringdata0))
        return static_cast<void*>(const_cast< TestQuaZipFileInfo*>(this));
