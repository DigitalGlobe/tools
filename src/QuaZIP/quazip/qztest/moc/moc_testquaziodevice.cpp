...
const QMetaObject TestQuaZIODevice::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestQuaZIODevice.data,
      qt_meta_data_TestQuaZIODevice,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TestQuaZIODevice::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TestQuaZIODevice.stringdata0))
        return static_cast<void*>(const_cast< TestQuaZIODevice*>(this));
