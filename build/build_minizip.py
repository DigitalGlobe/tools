...
class Program :
    ...
    # constants
        ...
        _FILE_NAME_SOLUTION = "minizip.vcxproj"
        _FILE_NAME_SOLUTION_2 = "aes.vcxproj"
    ...
    # public methods
        ...
        def main(self) :
            ...
            if ( buildSettings.ReleaseSpecified() and \
                 ...
                 zlibFileName                = pathFinder.path( buildPathName , \
            ...
            zlibIncludeFileName = pathFinder.path( buildPathName , Program._ZLIB_INCLUDE_DIR                               )
            ...
            if ( buildSettings.X64Specified() ) :
                ...
                cmakeCommandLine = ( ( "%s "                                + \
                                       ...
                                       "-DZLIB_LIBRARY_DEBUG=\"" + zlibFileName + "\" " + \
                                       "-DZLIB_LIBRARY_RELEASE=\"" + zlibFileName + "\" " + \
