...
class Program :
        DESCRIPTION = "Builds the LasZip library."
        ...
        def main(self) :
            ...
            intermedOutDir = buildPathName + "\\LASZip\\LASZip" + buildOutDir
            buildOutDir = buildPathName + "\\LASZip" + buildOutDir
