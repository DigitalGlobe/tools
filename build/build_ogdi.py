...
class Program :
        ...
        def main(self) :
            ...
            intermedOutDir = buildPathName + "\\OGDI\\OGDI" + buildOutDir
            buildOutDir = buildPathName + "\\OGDI" + buildOutDir
            ...
            #    print( "copying " + file + " -> " + sdkOutDir)
            #    shutil.copy(file, sdkOutDir)
            shutil.copy( buildOutDir + "\\librpc.lib", sdkOutDir + "\\librpc" + suffix + ".lib")
            shutil.copy( buildOutDir + "\\OGDI.dll", sdkOutDir + "\\OGDI" + suffix + ".dll")
            shutil.copy( buildOutDir + "\\OGDI.pdb", sdkOutDir + "\\OGDI" + suffix + ".pdb")
            shutil.copy( buildOutDir + "\\libOGDI.lib", sdkOutDir + "\\libOGDI" + suffix + ".lib")
            shutil.copy( buildOutDir + "\\libOGDI.pdb", sdkOutDir + "\\libOGDI" + suffix + ".pdb")
