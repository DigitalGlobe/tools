...
class Program :
        ...
        def main(self) :
            ...
            # start building
            systemManager.changeDirectory(pathFinder.path(buildPathName, 'win32'))
            ...
            nmakeCommandLine += ' ZLIB_INC=' + pathFinder.path(buildPathName, Program._ZLIB_INCLUDE)
            nmakeCommandLine += ' ZLIB_LIB=' + zlibLibraryFileName
            nmakeCommandLine += ' ICONV_INC=' + pathFinder.path(buildPathName, Program._ICONV_INCLUDE)
            ...
            buildOutDir   = pathFinder.path( buildPathName, 'win32\\bin.msvc' )
