...
class Program :
    ...
    def main(self):
        ...
        externalLibs = {
            ...
            "FileGDB_LIBRARY": pathFinder.slasher(pathFinder.path(sdkOutDir, "filegdbapi.lib")),
            ...
            "GEOS_LIBRARY": pathFinder.slasher(pathFinder.path(sdkOutDir, "geos_c.lib")),
            "GEOTIFF_INCLUDE_DIR": pathFinder.slasher(pathFinder.path(includeBase, "libgeotiff")),
            "GEOTIFF_LIBRARY": pathFinder.slasher(pathFinder.path(sdkOutDir, "libgeotiff.lib")),
            ...
            "Iconv_LIBRARY": pathFinder.slasher(pathFinder.path(sdkOutDir, "libiconv.lib")),
            "Iconv_CHARSET_LIBRARY": pathFinder.slasher(pathFinder.path(sdkOutDir, "charset.lib")),
            ...
            "LIBKML_MINIZIP_LIBRARY": pathFinder.slasher(pathFinder.path(sdkOutDir, "minizip.lib")),
            "LIBKML_MINIZIP_AES_LIBRARY": pathFinder.slasher(pathFinder.path(sdkOutDir, "aes.lib")),
            "LIBKML_URIPARSER_LIBRARY": pathFinder.slasher(pathFinder.path(sdkOutDir, "uriparser.lib")),
            "LIBKML_BASE_LIBRARY": pathFinder.slasher(pathFinder.path(sdkOutDir, "kmlbase.lib")),
            "LIBKML_DOM_LIBRARY": pathFinder.slasher(pathFinder.path(sdkOutDir, "kmldom.lib")),
            "LIBKML_ENGINE_LIBRARY": pathFinder.slasher(pathFinder.path(sdkOutDir, "kmlengine.lib")),
            ...
            "MUPARSER_LIBRARY": pathFinder.slasher(pathFinder.path(sdkOutDir, "muparser.lib")),
            ...
            # "PODOFO_LIBRARY": pathFinder.slasher(pathFinder.path(sdkOutDir, "podofo.lib")),
            ...
            # "XercesC_LIBRARY": pathFinder.slasher(pathFinder.path(sdkOutDir, "xerces.lib")),
            ...
            "ZSTD_LIBRARY": pathFinder.slasher(pathFinder.path(sdkOutDir, "zstd.lib")),
        }
        ...
        cmakeCommandLine = (
            ...
            + f"-A {platform} "
            + f"-DGDAL_DEBUG_POSTFIX={Program._DEBUG_SUFFIX} "
