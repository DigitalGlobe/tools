...
class Program :
    ...
    # constants
        ...
        _FILE_NAME_SOLUTION_2 = "cryptopp-static.vcxproj"
        _FILE_NAME_SOLUTION = "cryptopp-object.vcxproj"
    ...
    # public methods
        ...
        def main(self) :
            ...
            cmakeCommandLine += ' -DBUILD_DOCUMENTATION=0 -DBUILD_SHARED=0 -DBUILD_STATIC=1 -DBUILD_TESTING=0'
