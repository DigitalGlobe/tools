...
class Program:
    ...
    DESCRIPTION = "Builds the NGHTTP2 library."
    ...
    _PATH_NAME_SOURCE = "..\\src\\NGHTTP2"
    # ----------------------------------------------------------------------
    # the name of the path for all include files
    _PATH_NAME_INCLUDE = "nghttp2"
    # ----------------------------------------------------------------------
    ...
    def main(self):
        ...
        systemManager.distributeFiles(
            pathFinder.path( cmakeInstallPath,"include", "nghttp2"),
