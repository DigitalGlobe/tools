...
class Program:
    ...
    def main(self):
        ...
        externalLibs = {
            ...
            "CURL_LIBRARY": pathFinder.path(sdkOutDir, "libcurl.lib"),
            "FREETYPE_INCLUDE_DIR": pathFinder.path(includeBase, "freetype"),
            "FREETYPE_LIBRARY": pathFinder.path(sdkOutDir, "freetype.lib"),
            ...
            "LIBXML2_LIBRARY": pathFinder.path(sdkOutDir, "libxml2.lib"),
