...
class Program :
    ...
    # constants
        ...
        _FILE_NAME_SOLUTION = "freetype.vcxproj"
        ...
        _PATH_NAME_INCLUDE = 'include\\freetype'
        #----------------------------------------------------------------------
    ...
    # public methods
        ...
        def main(self) :
            ...
            cmakeCommandLine += ' -DZLIB_INCLUDE_DIR="' + zlibIncludeFileName + '"'
            cmakeCommandLine += ' -DZLIB_LIBRARY="' + zlibFileName + '"'
