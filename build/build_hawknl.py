...
class Program:
    ...
    _FILE_NAME_SOLUTION = "nl.vcxproj"
    ...
    def main(self):
        ...
        systemManager.appendToPathEnvironmentVariable(
            os.path.join(
                systemManager.getProgramFilesPathName(False), "MSBuild\\14.0\\Bin"
            )
        )
        ...
        if buildSettings.X64Specified():
            ...
            systemManager.appendToPathEnvironmentVariable(
                os.path.join(
                    systemManager.getProgramFilesPathName(False),
        ...
        pthreadLib = os.path.join(
            sdkOutDir,
            Program._PTHREAD_LIB
        ...
        if buildSettings.X64Specified():
            ...
            cmakeCommandLine = ("%s " + '-G"Visual Studio 14 2015" ' + '"%s"') % (
                PathFinder.FILE_NAME_CMAKE,
                buildSourceName,
            )

        cmakeCommandLine += ' -DPTHREAD_LIBRARY="' + pthreadLib + '"'
