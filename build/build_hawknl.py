...
class Program :
        ...
        def main(self) :
            ...
            cmd = "msbuild HawkNL.sln "
            
            buildOutDir = ""

            # extend command line based on options
            if ( buildSettings.X64Specified() ) :
                cmd = cmd + "/p:platform=Win64 "
            ...
            shutil.copy(buildOutDir + "\\" + "NLStatic" + suffix + ".lib", sdkOutDir)
            shutil.copy(buildOutDir + "\\" + "NLStatic" + suffix + ".pdb", sdkOutDir) 
            shutil.copy(buildOutDir + "\\" + "HawkNL" + suffix + ".dll", sdkOutDir)
            shutil.copy(buildOutDir + "\\" + "HawkNL" + suffix + ".pdb", sdkOutDir) 
            
            if ( buildSettings.X64Specified() ) :
            	shutil.copy(buildOutDir + "\\pthreadVC2_x64.lib", sdkOutDir)
            else:
            	shutil.copy(buildOutDir + "\\pthreadVCE.lib", sdkOutDir)
