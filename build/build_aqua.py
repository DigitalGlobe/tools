...
# build_aqua.py
#
# Summary : Builds the Aqua library
#
#------------------------------------------------------------------------------
...
class Program :
        DESCRIPTION = "Builds Aqua"
        _PATH_NAME_BINARY_X86 = "..\\sdk\\x86\\bin"
        _PATH_NAME_BINARY_X64 = "..\\sdk\\x64\\bin"
        _PATH_NAME_BUILD = "Aqua"
        _PATH_NAME_DISTRIBUTION_X86 = "..\\sdk\\x86\\lib"
        _PATH_NAME_DISTRIBUTION_X64 = "..\\sdk\\x64\\lib"
        _PATH_NAME_SOURCE = "..\\src\\Aqua"
        ...
        def main(self) :
            ...
            intermedOutDir = buildPathName + "\\Aqua" + buildOutDir
            buildOutDir = buildPathName + "\\Build" + buildOutDir
            ...
            #    print( "copying " + file + " -> " + sdkOutDir)
            #    shutil.copy(file, sdkOutDir)
            shutil.copy( buildOutDir + "\\libAqua.lib", sdkOutDir + "\\libAqua" + suffix + ".lib")
            shutil.copy( buildOutDir + "\\libAqua.pdb", sdkOutDir + "\\libAqua" + suffix + ".pdb")
