...
class Program :
    ...
    # constants
        ...
        _PATH_NAME_SOURCE = "..\\src\\pthreads.2"
        #----------------------------------------------------------------------
    ...
    # public methods
        ...
        def main(self) :
            ...
            libNameMake = Program._LIBNAME_MAKE + ( '' if ( buildSettings.ReleaseSpecified() )  else Program._DEBUG_SUFFIX) + ".lib"


            # run Nmake
            nmakeCommandLine = 'nmake -f Makefile realclean clean VC-static' + ( '' if ( buildSettings.ReleaseSpecified() )  else '-debug')
