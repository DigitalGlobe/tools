...
class Program :
        ...
        _FILE_NAME_SOLUTION = "projects\\Windows\\VC14\lib\\libcurl.vcxproj"
        ...
        _PATH_NAME_INCLUDE = 'include\\curl'
        #----------------------------------------------------------------------
        ...
        def main(self) :
            ...
            conf = '"DLL Release"' if ( buildSettings.ReleaseSpecified() ) else '"DLL Debug"'
