...
class Program :
    ...
    # public methods
        ...
        def main(self) :
            ...
            buildBoostCommandLine =  "b2 toolset=msvc-14.0 -a --abbreviate-paths architecture=x86 --with-python --prefix=../../build/Boost install link=shared runtime-link=shared -j4"
