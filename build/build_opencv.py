...
class Program :
    ...
    def main(self):
        ...
        srcIncludePath = pathFinder.path(cmakeInstallPath, "include", "opencv2")
        srcLibPath = pathFinder.path(cmakeBuildPath, "lib", conf)
        srcBinPath = pathFinder.path(cmakeBuildPath, "bin", conf)
